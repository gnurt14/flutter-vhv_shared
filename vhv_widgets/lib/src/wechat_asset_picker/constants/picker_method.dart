...
class PickMethod {
      ...
      method: (BuildContext context, List<AssetEntity> assets) {
        return AssetPicker.pickAssets(
          ...
          pickerConfig: AssetPickerConfig(
            ...
            limitedPermissionOverlayPredicate: (per){
              return false;
            },
            specialItemBuilder: (
              ...
              return GestureDetector(
                ...
                child: Center(
                  child: Icon(ViIcons.camera_plus, size: 42.0),
                ),
              );
            },
          ),
  ...
  factory PickMethod.cameraAndStay({required int maxAssetsCount, RequestType requestType = RequestType.common,}) {
    return PickMethod(
      icon: '📸',
