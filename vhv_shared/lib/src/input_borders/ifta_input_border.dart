...
class IFTAInputBorder extends InputBorder {
  ...
  @override
  IFTAInputBorder scale(double t) {
    return IFTAInputBorder(
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is IFTAInputBorder) {
      final IFTAInputBorder outline = a;
      return IFTAInputBorder(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is IFTAInputBorder) {
      final IFTAInputBorder outline = b;
      return IFTAInputBorder(
  ...
  bool operator ==(Object other) {
    ...
    return other is IFTAInputBorder
