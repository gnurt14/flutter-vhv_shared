...
extension VHVSharedContextExtension on BuildContext {
  AppThemeExtension? get appTheme => Theme.of(this).extension<AppThemeExtension>();

  BottomSheetType get bottomSheetType => appTheme?.bottomSheetType ?? helper.BottomSheetType.type2;

  String get appLogo{
    return appTheme?.logo ?? '';
  }

  AuthHandler get authHandler => account.authHandler;


  bool get isTwoColumn => MediaQuery.of(this).size.width >= 840;
  ...
  void requestFocusNode() => FocusScope.of(this).requestFocus(FocusNode());
  ...
  bool get isPhone => deviceTypeName == 'mobile' || deviceTypeName == 'watch';
  bool get isMobile => isPhone;

  bool get isTablet => deviceTypeName == 'tablet';
  bool get isDesktop => deviceTypeName == 'desktop';
  bool get isWatch => deviceTypeName == 'watch';

  /// True if the current device is Tablet

  String get deviceTypeName => getValueForScreenType<String>(
      context: this,
      mobile: 'mobile',
      tablet: 'tablet',
      desktop: 'desktop',
