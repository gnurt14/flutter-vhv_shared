...
var DateTimeUtils = _DateUtils.instance;

class _DateUtils {
  _DateUtils._();
  static _DateUtils? _instance;
  static _DateUtils get instance{
    _instance ??= _DateUtils._();
    return _instance!;
  }
  ...
  bool isCurrentMonth(DateTime m) {
    var year = m.year;
    var month = m.month;
    final today = time().toString().toDateTime();
    return DateTime(year, month) == DateTime(today.year, today.month);
  }
  ...
  bool isCurrentWeek(DateTime m) {
    return isSameWeek(time().toString().toDateTime(), m);
  }
  DateTime currentDay() {
    return time().toString().toDateTime();
  }
  bool isToday(DateTime day){
    return isSameDay(time().toString().toDateTime(), day);
  }
}
