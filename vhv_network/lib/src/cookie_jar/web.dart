...
/// [CustomPersistCookieJar] is a cookie manager which implements
/// the standard cookie policy declared in RFC.
/// [CustomPersistCookieJar]  persists the cookies in files, if the application exit,
/// the cookies always exist unless user explicitly called [delete].
class CustomPersistCookieJar extends DefaultCookieJar {
