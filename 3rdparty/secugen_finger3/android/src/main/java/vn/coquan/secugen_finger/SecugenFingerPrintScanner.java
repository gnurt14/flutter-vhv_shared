//package com.bitel.bss.viettelpos.v3.widget.fingerprintscanner;
//
...
//
//import com.bitel.bss.viettelpos.v3.BitelApplication;
//import com.bitel.bss.viettelpos.v3.config.Config;
//import com.bitel.bss.viettelpos.v3.util.DialogUtils;
...
//    private final int[] quality1 = new int[1];
//    private int mImageWidth;
//    private int mImageHeight;
//    // CaptureModeN enable
//    private final boolean isCaptureModeN = false;
//    private long secugenDeviceError;
//    private UsbDevice usbDevice;
//    private final boolean isSmartCapture = true;
//    private boolean usbReceiverRegistered = false;
//    private SGAutoOnEventNotifier autoOn;
//    public SecugenFingerPrintScanner(Context context){
//        super(context,(AppCompatActivity) BitelApplication.getCurrentAct());
//    }
//
//    @Override
...
//        if(!resume) {
//            sgfplib = new JSGFPLib((UsbManager) BitelApplication.getCurrentAct().getSystemService(Context.USB_SERVICE));
...
//        System.out.println("UsbDevice:" + new Gson().toJson(usbDevice));
//        if(usbDevice != null) {
//            sgfplib.GetUsbManager().requestPermission(usbDevice, mPermissionIntent);
//        }
//        else
//        {
//            DialogUtils.showErrorServer(BitelApplication.getCurrentAct(),"warning_usb_device_not_available");
//
//        }
//    }
//
...
//
//            BitelApplication.getCurrentAct().runOnUiThread(new Runnable() {
//                @Override
//                public void run() {
//                    Toast.makeText( BitelApplication.getCurrentAct(), "error_capture_finger", Toast.LENGTH_SHORT).show();
//                }
//            });
//        }
//        else {
...
//    }
//
//    private final Handler fingerDetectedHandler = new Handler() {
//        // @Override
...
//            mPermissionIntent = PendingIntent.getBroadcast(context, 0, explicitIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
//        } else if (android.os.Build.VERSION.SDK_INT <= Build.VERSION_CODES.TIRAMISU) {
//            mPermissionIntent = PendingIntent.getBroadcast(context, 0, explicitIntent, PendingIntent.FLAG_MUTABLE);
//        }
//    }
//
...
//
//                    } else {
//                        FingerScannerFactory.createEmptyFingerPrint();
//                    }
//                }
//            }
//        }
