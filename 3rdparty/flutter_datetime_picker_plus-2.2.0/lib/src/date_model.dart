...
abstract class BasePickerModel {
  ...
  String? labelText;
  CommonPickerModelRanger? get leftRanger => null;
  CommonPickerModelRanger? get middleRanger => null;
  CommonPickerModelRanger? get rightRanger => null;
...
class CommonPickerModelRanger{
  final int start;
  final int end;
  const CommonPickerModelRanger(this.start, this.end) : assert(start <= end);
