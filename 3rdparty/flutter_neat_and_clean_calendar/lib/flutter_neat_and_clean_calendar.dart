...
class Calendar extends StatefulWidget {
  ...
  final Widget? Function(String displayMonth, Function()? nextMonth,
      Function()? previousMonth)? displayMonthBuilder;
  final Widget? headerBuilder;
  final Widget? Function(List<Widget> calendarBuilder)? gridDayBuilder;
  ...
  Calendar(
      ...
      this.weekDays = const ['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'],
      this.locale = 'en_US',
      ...
      this.displayMonthBuilder,
      this.showBottom = true,
      this.headerBuilder,
      this.dayCustomBuilder,
      this.gridDayBuilder});
...
class _CalendarState extends State<Calendar> {
    ...
    if (widget.eventsList != null &&
      ...
      widget.eventsList!.forEach((event) {
        final int range = event.endTime
            ...
            .difference(event.startTime.copyWith(hour: 0, minute: 0))
            .inDays;
  ...
  Widget get nameAndIconRow {
    ...
    return widget.displayMonthBuilder
            ?.call(displayMonth, nextMonth, previousMonth) ??
        Row(
  ...
  Widget get calendarGridView {
    return Container(
      child: SimpleGestureDetector(
        ...
        child: Column(
          children: <Widget>[
            widget.gridDayBuilder?.call(calendarBuilder()) ??
                GridView.count(
        ...
        if (this.widget.dayBuilder != null) {
          ...
          dayWidgets.add(
            NeatCleanCalendarTile(
              ...
              dayCustomBuilder: widget.dayCustomBuilder,
              date: day,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          nameAndIconRow,
          widget.headerBuilder ?? SizedBox(),
          ExpansionCrossFade(
            collapsed: calendarGridView,
            expanded: calendarGridView,
            isExpanded: isExpanded,
          ),
          if (widget.showBottom) expansionButtonRow,
  ...
  void nextMonth() {
    setState(() {
      ...
      if(Utils.isCurrentMonth(_selectedDate)){
