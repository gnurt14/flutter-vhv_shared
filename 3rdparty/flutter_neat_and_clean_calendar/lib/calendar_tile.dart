...
class NeatCleanCalendarTile extends StatelessWidget {
  ...
  Widget renderDateOrDayOfWeek(BuildContext context) {
    ...
    if (isDayOfWeek) {
      ...
      int eventCount = 0;
      return dayCustomBuilder?.call(onDateSelected, events, date, isSelected,
              Utils.isSameDay(this.date!, DateTime.now()), inMonth) ??
          InkWell(
            onTap: onDateSelected, //
            borderRadius: BorderRadius.circular(30), // react on tapping
            child: Padding(
