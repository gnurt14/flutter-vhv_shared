...
class SpanishAssetPickerTextDelegate extends AssetPickerTextDelegate {
  ...
  @override
  String get unableToAccessAll => 'No se puede acceder a todos los archivos en el dispositivo';

  @override
  String get viewingLimitedAssetsTip =>
      'Solo se pueden ver los archivos y álbumes accesibles para la app.';

  @override
  String get changeAccessibleLimitedAssets =>
      'Haz clic para actualizar los archivos accesibles';

  @override
  String get accessAllTip =>
      'La app solo puede acceder a algunos archivos en el dispositivo. '
          'Ve a la configuración del sistema y permite el acceso a todos los archivos.';
