...
class SpanishCameraPickerTextDelegate extends CameraPickerTextDelegate {
  ...
  String get shootingWithRecordingTips =>
      'Toca para tomar una foto. Mantén presionado para grabar video.';

  @override
  String get shootingOnlyRecordingTips => 'Mantén presionado para grabar video.';
  ...
  String? sCameraPreviewLabel(CameraLensDirection? value) {
    ...
    return 'Vista previa de la cámara ${sCameraLensDirectionLabel(value)}';
  }
  ...
  @override
  String sSwitchCameraLensDirectionLabel(CameraLensDirection value) =>
      'Cambiar a la cámara ${sCameraLensDirectionLabel(value)}';
}
